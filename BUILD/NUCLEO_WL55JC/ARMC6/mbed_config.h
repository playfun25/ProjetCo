...
#define LPTICKER_DELAY_TICKS                                                  0                                                                                                  // set by target:MCU_STM32WL
...
#define MBED_CONF_LORA_APPLICATION_EUI                                        { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x04, 0xE3, 0xA7 }                                                 // set by application[*]
#define MBED_CONF_LORA_APPLICATION_KEY                                        { 0x1C, 0xF6, 0x0E, 0x6B, 0xD8, 0xB3, 0x04, 0xC8, 0xEC, 0x7D, 0x8F, 0xAD, 0x14, 0x6F, 0x07, 0xD0 } // set by application[*]
...
#define MBED_CONF_LORA_DEVICE_EUI                                             { 0x00, 0x80, 0xE1, 0x15, 0x05, 0x00, 0x5B, 0xAE }                                                 // set by application[*]
...
#define MBED_CONF_LORA_MAX_SYS_RX_ERROR                                       10                                                                                                 // set by library:lora[STM32WL]
...
#define MBED_CONF_LORA_WAKEUP_TIME                                            3                                                                                                  // set by library:lora[STM32WL]
...
#define MBED_CONF_STM32WL_LORA_DRIVER_RF_SWITCH_CONFIG                        RBI_CONF_RFO_LP_HP                                                                                 // set by library:stm32wl-lora-driver
#define MBED_CONF_STM32WL_LORA_DRIVER_RF_SWITCH_CTL1                          PC_4                                                                                               // set by library:stm32wl-lora-driver[NUCLEO_WL55JC]
#define MBED_CONF_STM32WL_LORA_DRIVER_RF_SWITCH_CTL2                          PC_5                                                                                               // set by library:stm32wl-lora-driver[NUCLEO_WL55JC]
#define MBED_CONF_STM32WL_LORA_DRIVER_RF_SWITCH_CTL3                          PC_3                                                                                               // set by library:stm32wl-lora-driver[NUCLEO_WL55JC]
#define MBED_CONF_STM32WL_LORA_DRIVER_RF_WAKEUP_TIME                          10                                                                                                 // set by library:stm32wl-lora-driver
#define MBED_CONF_STM32WL_LORA_DRIVER_SLEEP_MODE                              0                                                                                                  // set by library:stm32wl-lora-driver
#define MBED_CONF_STM32WL_LORA_DRIVER_STANDBY_MODE                            STDBY_RC                                                                                           // set by library:stm32wl-lora-driver
...
#define MBED_CONF_TARGET_I2C_TIMING_VALUE_ALGO                                0                                                                                                  // set by target:MCU_STM32WL
